...
var range_blue = ["#fee0d2","#fc9272","#de2d26"];
var index_one = 0;

//draw first chart

var chart = d3.circularHeat()
	.domain([0,2,4,6])// should make this dynamic
	.range(range_blue)
...
function swapDataset(passedData,radiallabels){
	chart.radialLabels(radiallabels).domain([0,2,4,6]).range(range_blue);// should make this dynamic
